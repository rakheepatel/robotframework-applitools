...
from applitools.target import Target, IgnoreRegionBySelector
...
class RobotAppEyes:
    ...
    *Using Selectors*
    ...
    def check_eyes_window_ignore_region_by_selector(self, selector, value, name, force_full_page_screenshot=False,
                                                    includeEyesLog=False, httpDebugLog=False):
        ...
        eyes.force_full_page_screenshot = force_full_page_screenshot
        eyes.check_window(name, target=Target().ignore(IgnoreRegionBySelector(searchElement, value)));
